...
<head>
    ...
    <style>
        ...
        /* Signature styling - Consistent with PR, AOQ, BAC, PO, RFQ */
        .signature-container {
            width: 100%;
            height: 30px;
            text-align: center;
...
<body>
    ...
    <table style="font-size: 8pt; margin-left: 10px; margin-top: 15px;">
        ...
        <tr style="height: 19px;">
            ...
            <td class="s21">5.</td>
            <td class="s11" colspan="24">Latest Income/Business Tax Return (for ABCs above Php 500,000.00);</td>
        </tr>
        <tr style="height: 19px;">
            <td class="s22" style="border-left: 2px solid #000000;">
        ...
        <tr>
            <td style="text-align: left; padding-top: 10px;">
                @if($bacChairpersonApproval && $bacChairpersonApproval->signature)
                    <div class="signature-container" style="margin-left:50px;">
