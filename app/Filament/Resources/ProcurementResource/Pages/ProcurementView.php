                ...
                Section::make('Purchase Request')
                    ->schema([
                        ...
                        TextEntry::make('pr_status')
                            ...
                            ->getStateUsing(fn ($record) =>
                                $record->children->where('module', 'purchase_request')->first()?->status ?? 'Pending'
                            ),
                ...
                Section::make('Request for Quotation')
                    ->schema([
                        ...
                        TextEntry::make('rfq_status')
                            ...
                            ->getStateUsing(fn ($record) =>
                                $record->children->where('module', 'request_for_quotation')->first()?->status ?? 'Pending'
                            ),
                ...
                Section::make('Abstract of Quotation')
                    ->schema([
                        ...
                        TextEntry::make('aoq_status')
                            ...
                            ->getStateUsing(fn ($record) =>
                                $record->children->where('module', 'abstract_of_quotation')->first()?->status ?? 'Pending'
                            ),
                ...
                Section::make('BAC Resolution Recommending Award')
                    ->schema([
                        ...
                        TextEntry::make('bac_status')
                            ...
                            ->getStateUsing(fn ($record) =>
                                $record->children->where('module', 'bac_resolution_recommending_award')->first()?->status ?? 'Pending'
                            ),
                ...
                Section::make('Purchase Order')
                    ->schema([
                        ...
                        TextEntry::make('po_status')
                            ...
                            ->getStateUsing(fn ($record) =>
                                $record->children->where('module', 'purchase_order')->first()?->status ?? 'Pending'
                            ),
